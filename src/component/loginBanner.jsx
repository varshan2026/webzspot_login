...
function LoginBanner() {
  ...
  return (
    <div
      className="loginbanner-container w-[100vw] xl:w-[50vw] h-[75vh] md:h-[90vh] xl:h-[100vh] flex justify-center items-center bg-[#3c6e71] bg-no-repeat bg-[length:auto] bg-[-320px_255px]"
      style={{ backgroundImage: `url(${round})` }}
    >
      <div className="flex justify-center items-center">
        <motion.div
          key={currentIndex}
          className="h-[65vh] xl:h-[90vh] w-[86vw] xl:w-[45vw] border rounded-lg border-white px-6.5 py-6 bg-white/12 backdrop-blur-sm relative"
        >
          <motion.h1
          ...
          <motion.h5
            className="text-lg xl:text-xl text-white mt-4 xl:mt-5 leading-7 w-70 xl:w-90"
            initial={{ opacity: 0, x: 0 }}
            animate={{ opacity: 1, x: 0 }}
            exit={{ opacity: 0, x: -50 }}
            transition={{ duration: 0.9 }}
